                    ...
                    <div className='relative z-1 max-w-[17rem] ml-auto'>
                        ...
                        <ul className='body-2'>
                            {brainwaveServices.map((item, index)=>(
                                <li className='flex items-start py-4 border-t
                                border-n-6' key={index}>
                ...
                <div className='relative z-1 grid gap-5 lg:grid-cols-2'>
                    ...
                    <div className='p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem]'>
                        ...
                        <div className='relative h-[20rem] bg-n-8 rounded-xl overflow-hidden
                         md:h-[25rem]'>
                            <img src={service3} className='w-full h-full object-contain' width={520} height={400}
                             alt="scary robot" />
                             <VideoChatMessage/>
                             <VideoBar/>
                        </div>
